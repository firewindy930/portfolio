...
export const projects: SideProject[] = [
  ...
  {
    id: "8",
    title: "BlockChain Casino Game",
    description: `A full-featured casino site platform designed for scalability and performance, featuring seamless integration with a professional slot game API, real-time gameplay, secure transactions, user management, analytics, and a modern interface optimized for web and mobile users.`,
    image: "/blockchain-casino-game.png",
    demoUrl: "https://mortalsoft.net/",
    githubUrl: "https://github.com/firewindy930/blockchain-casino-game",
    category: "blockchain",
    technologies: ["PHP", "CSS", "Javascript", "BlockChain", "Smarty", "Hacking", "AI-Integration"],
  },
  {
    id: "9",
    title: "EVM Solana Casino Games",
    description: `ggsol.io is a Web3-based blockchain gaming platform and decentralized gambling/play-to-earn project built on the Solana blockchain. It revolves around using crypto wallets and tokens rather than traditional accounts and deposits`,
    image: "/evm-solana-casino-games.png",
    demoUrl: "https://ggsol.io/",
    githubUrl: "https://github.com/firewindy930/EVM-Solana-Casino-Games",
    category: "blockchain",
